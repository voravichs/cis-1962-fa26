        ...
        >
            <div className="mx-auto flex items-center gap-6 px-4 sm:px-8 md:px-12 lg:px-24 xl:px-32 py-4 max-w-7xl">
                ...
                <div className="flex flex-col flex-1 text-black dark:text-white">
                    ...
                    <span className="hidden md:flex opacity-75 text-lg md:text-xl mb-4">Fall 2026 &#8226; Thursday 5:15-6:45 PM &#8226; Amy Gutmann Hall 216B</span>
                    ...
                    <div className="hidden md:flex lg:hidden xl:hidden gap-3 mt-4">
                        <a href="https://canvas.upenn.edu/courses/1948504" className="flex flex-col items-center group" target="_blank" rel="noopener noreferrer" aria-label="Canvas">
                            <span className={iconBtnClass}>
                                <SiCanvas />
                            </span>
                            <span className="text-sm mt-1 group-hover:text-red-500 tracking-wide font-semibold">Canvas</span>
                        </a>
                        <a href="https://edstem.org/us/courses/102363/discussion" className="flex flex-col items-center group" target="_blank" rel="noopener noreferrer" aria-label="Ed Discussion">
                            <span className={iconBtnClass}>
                                <GiDiscussion />
                            </span>
            ...
            >
                ...
                <p className="text-black/75 text-lg text-center py-4">Fall 2026 &#8226; Thursday 5:15-6:45 PM &#8226; Amy Gutmann Hall 216B</p>
