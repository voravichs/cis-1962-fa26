...
const gradeBreakdown = [
  { label: "Attendance", percent: 5, color: "bg-purple-400" },
  { label: "Homework", percent: 50, color: "bg-blue-400" },
  { label: "Ed Quizzes", percent: 20, color: "bg-green-400" },
  { label: "Final Project", percent: 25, color: "bg-orange-400" },
];
        ...
        <div className="scroll-mt-48 max-w-5xl mx-auto text-lg text-black dark:text-white">
            ...
            <div className="flex flex-col gap-12">
                ...
                <section className="space-y-8">
                    ...
                    <p className="ml-4">
                        This mini-course of CIS 1962 will be focused on working towards building full-stack web applications using JavaScript and modern frameworks. This section will not go in depth into topics like exploring specific backend libraries and solutions for the web, rather it aim to equip students with the fundamentals of making robust web applications and encouraging students to explore specific libraries and technologies on their own.
                    </p>
                </section>
                ...
                <section className="space-y-8">
                    ...
                    <div>
                        ...
                        <ul className="flex justify-center gap-8 mt-2 flex-wrap">
                            {gradeBreakdown.map((item) => (
                ...
                <section className="space-y-8">
                    ...
                    <div className="ml-4 space-y-4">
                        ...
                        <p className='ml-4'>We know that stuff happens during the semester that's out of your control. Midterms, interviews, and other unforeseen circumstances may prevent you from submitting assignments on time. Thus, we have a 72 hour late submission policy, where each assignment can be submitted up to 72 hours late for 15% off of the grade. We will not accept submission after this deadline unless an extension is granted by the instructor.</p>
                    </div>
                    <div className="ml-4 space-y-4">
                        <h3 className='text-xl font-bold text-indigo-600'>Resubmission and Regrades</h3>
                        <p className='ml-4'>If you would like to resubmit an assignment after it is graded, or if you miss the original deadline and the late submission period, you will have an opportunity to resubmit for a regrade at the end of the semester. We will open a Google Form at the end of the semester to facilitate these submissions, so look out for an Ed post about it if you are interested. All resubmission are subject to a 30% penalty, meaning that the max grade you can get is 70% for resubmissions.</p>
                    </div>
                ...
                <section className="space-y-8">
                    ...
                    <div className="ml-4 space-y-4">
                        <p>
                            Implementation details for homeworks and final projects should be <span className="red-bold">individual work</span>, authored by the student without help from others or AI, and reflect work associated specifically made for this class, and no other past or present classes.
                        </p>
                        <p>
                ...
                <section className="space-y-8">
                    ...
                    <div className="ml-4 space-y-4">
                        ...
                        <p>
                            However, at the same time, it is difficult to detect AI usage in code. A lot of IDEs (like VSCode) already have AI tools like Copilot built into their interfaces, and even Google has fully implemented AI summaries for searches. AI tools can be supremely helpful for learning topics and used as a "search engine" for conceptual questions. As such, we would humbly ask that you hold yourself accountable for your own AI usage when working on assignments. You will absorb less information if you simply just generate all the code for an assignment using AI, rather than working through the problems and concepts yourself!
                        </p>  
                        <p>
