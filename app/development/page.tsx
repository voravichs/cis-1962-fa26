        ...
        <div className="scroll-mt-48 max-w-5xl mx-auto text-lg text-black dark:text-white">
            ...
            <div className="space-y-16">
                ...
                <section className="space-y-8">
                    ...
                    <p className='ml-4'>
                        If already installed and updated, you should get something along the lines of <span className='inline-code'>v26.7.0</span> for node and <span className='inline-code'>12.0.2</span> for npm. If your node version is less than <span className='inline-code'>24</span>, consider installing a more recent release. If an error or no version shows up, you will need to download a new version of node and npm using the instructions below.
                    </p>
                    <p className='ml-4'>
                        <b>Node Version Manager (nvm) </b> is one of the recommended ways for installing node. It provides users fine control of what node version is installed on the system, and even allows multiple versions to be installed for various purposes. Follow the directions under &quot Install &amp; Update Script" at <XLink link="https://github.com/nvm-sh/nvm#install--update-script" text="the nvm github page"/>. Note that you may have to update some environment variables for nvm to work. If you are on <b>Windows</b>, you can also use the <span className='inline-code'>nvm-setup.exe</span> installer from <XLink link="https://github.com/coreybutler/nvm-windows/releases/tag/1.2.2" text="this github page"/> to install nvm. Once nvm is installed, you can install the most recent version of node and npm through this command:
                    </p>
                    <p className='blue-block font-mono'>
                        nvm install --lts
                    </p>
